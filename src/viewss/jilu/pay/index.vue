    ...
    <div class="bar">
        ...
        <el-table :data="juluData" border style="width: 100%">
            ...
            <el-table-column  label="名字" align="center">
                <template slot-scope="scope" >
                     <div style="display:flex; flex-direction:row; justify-content:space-between;">
                        <div style="margin-top: 5px;overflow: hidden;-webkit-line-clamp: 1;-webkit-box-orient: vertical;display: -webkit-box;">{{ scope.row.userName }}</div>
                        <el-button type="text" size="small" icon="el-icon-document-copy" @click="copyBtn(scope.row.userName)">复制</el-button>
                     </div>
                </template>
            </el-table-column>
             <!-- 钱包地址 -->
            ...
            <el-table-column  label="消耗方式" align="center">
                <template slot-scope="scope" >
                    <div style="margin-top: 5px;">{{ scope.row.typeTxt }}</div>
                </template>
            </el-table-column>
            <!-- USDT -->
            <el-table-column  label="USDT" align="center">
                <template slot-scope="scope" >
 ...
 import {logPay} from "@/api/user";
    ...
    methods: {
        ...
        async GetUseInfo() {
            ...
            const data = await logPay(_paget)
